...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* --- 2. NAVBAR (Sama seperti Home) --- */
        nav {
            position: absolute; top: 0; left: 0; width: 100%;
            padding: 20px 50px; display: flex; justify-content: space-between; align-items: center;
            z-index: 100; background: rgba(0,0,0,0.7); /* Agak gelap biar menu terbaca */
        }
        ...
        /* Dropdown CSS (Copy dari index.php jika perlu dropdown) */
        .dropdown { position: relative; }
        .dropdown-content { display: none; position: absolute; top: 100%; left: 0; background: rgba(0,0,0,0.9); min-width: 200px; padding-top: 10px; border-top: 3px solid #dea057; }
        .dropdown:hover .dropdown-content { display: block; }
        .dropdown-content a { display: block; padding: 10px 20px; border-bottom: 1px solid #444; }

        /* --- 3. HERO HEADER (Bagian Atas) --- */
        .page-header {
            position: relative; width: 100%; height: 60vh; /* Setengah layar saja */
            background-image: url('https://images.unsplash.com/photo-1589829085413-56de8ae18c73?q=80&w=2072&auto=format&fit=crop'); /* Gambar Timbangan Hukum */
        ...
        .cards-grid {
            display: grid;
            grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); /* Otomatis 3 kolom */
            gap: 30px;
        }
        ...
        .btn-read {
            display: inline-block; padding: 8px 20px; background: #1a1a1a; color: white;
            text-decoration: none; font-size: 0.8rem; font-weight: 600; border-radius: 4px; transition: 0.3s;
        }
...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="perantara.php" class="active">Perantara</a></li> <li><a href="#">Struktur Pengurus</a></li>
            <li class="dropdown">
                <a href="#">Layanan ▼</a>
                <div class="dropdown-content">
                    <a href="#">PKPA</a>
                    <a href="#">UPA / Konsultasi</a>
                    <a href="#">Pengangkatan & Sumpah</a>
                </div>
            </li>

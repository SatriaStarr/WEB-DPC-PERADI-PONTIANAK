    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-links a {
            ...
            transition: 0.3s ease; opacity: 0.9;
        }
        ...
        /* --- 7. FOOTER --- */
        footer { 
            background-color: #1e3a8a; padding: 60px 20px; text-align: center; color: white; border-top: 5px solid #dea057; 
        }
        ...
        /* Tombol Admin Footer */
        .admin-login-footer { margin-top: 15px; }
        .admin-login-footer a { color: #64748b; text-decoration: none; font-size: 0.8rem; transition: 0.3s; }
        .admin-login-footer a:hover { color: #dea057; }

        @keyframes fadeIn { from { opacity: 0; transform: translateY(20px); } to { opacity: 1; transform: translateY(0); } }
        @keyframes slideDown { from { opacity: 0; transform: translateY(-10px); } to { opacity: 1; transform: translateY(0); } }
        @media (max-width: 768px) { nav { padding: 15px 20px; } .nav-links { display: none; } .hero-title { font-size: 2.5rem; } }
    </style>
</head>
...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="peraturan.php">Peraturan</a></li> <li><a href="struktur.php">Struktur</a></li>

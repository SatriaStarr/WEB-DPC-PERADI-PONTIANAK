...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* --- 2. RUNNING TEXT (Biru Laut) --- */
        /* POSISI RELATIVE = IKUT GULUNG */
        ...
        /* --- 3. NAVBAR (Biru Donker) --- */
        /* POSISI RELATIVE = IKUT GULUNG JUGA */
        nav {
            position: relative; /* <--- INI KUNCINYA, JANGAN DIGANTI STICKY LAGI */
            top: 0;
            left: 0;
            width: 100%;
            padding: 15px 50px;
        ...
        .hero {
            ...
            margin-top: 0; /* Tidak perlu margin lagi */
        }
        ...
        .btn-cta {
            ...
            border-radius: 4px;
            transition: 0.3s;
            box-shadow: 0 4px 15px rgba(222, 160, 87, 0.4);
        }

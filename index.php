    ...
    <style>
        ...
        * {
        ...
        .btn-login-nav {
            ...
            border-radius: 4px;
            /* Kotak sedikit tumpul, lebih formal */
            transition: 0.3s;
            font-weight: 700;
        }
        ...
        .section-gallery {
            ...
            /* Biru Sangat Gelap (Hampir Hitam) agar foto pop-up */
            color: white;
            text-align: center;
        }
...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="admin/index.php" class="btn-login-nav">
